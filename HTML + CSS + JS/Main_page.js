...
document.getElementById('next1').addEventListener('click', function() {
  ...
  if (clickCount === 1) {
    ...
    textBox.textContent = 'Nyt, sinun kuuluu kerätä niin paljon adakiittitaikakiviä kuin voit, käyttämällä maailman lentokenttiä kiintopisteinä ja ' +
        'pysäyttää Kaik-Oo-Koo ennen kuin hän ehtii tuhota ilmaston! Pidä mielessä, jos et pidä tarpeeksi huolta ilmastosta, niin maapallo tuhoutuu.';
...
function createNewButtons() {
  ...
  button2.textContent = 'Matkusta uudelle kentälle';
  button2.id = 'next2';
  ...
  button3.textContent = 'Jää kentälle ja tee ilmastoteko';
  button3.id = 'next3';
