#Saa tehdä lisäys- ja muutosehdotuksia, kirjotin vaan esimerkkiä :)

#Alkuloree otsikon jälkeen
'''
Ilmasto lämpenee lämpenemistään ja sen estämiseen kykenevät tahot
vain tahkoavat rahaa ympäristön kustannuksella. On aika tarttua
toimeen elinympäristön puolustamiseksi!

Ab Ruksi Oy Corporationin toimitusjohtaja velho Suur-Ruksi ylläpitää
...
Vaan velho Suur-Ruksi on saanut vihiä aikeistasi anastaa kivet ja puhdistaa
