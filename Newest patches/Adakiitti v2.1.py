...
def pelaajat():
    sql = f"insert into peli1 (nimi) values ('{nimimerkki}')"
    kursori = yhteys.cursor()
    kursori.execute(sql)
    return
pelaajat()
...
def peli_alkaa():
    ...
    print(f" Hei {nimimerkki}! Muinaiset tietäjälahkot ovat sodassa! Vanhat lahkot, joiden tavoite on ilmastonmuutos,"
